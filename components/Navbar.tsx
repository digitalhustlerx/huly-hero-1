...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-5 bg-transparent backdrop-blur-[2px] transition-all duration-300">
      <div className="flex items-center gap-10">
        {/* Logo */}
        <a href="#" className="flex items-center gap-2.5 group">
          <div className="relative flex items-center justify-center">
            {/* Huly Logo Icon approximation */}
          ...
          <span className="font-bold text-xl tracking-tight text-white">huly</span>
        </a>

        {/* Desktop Links */}
        <div className="hidden lg:flex items-center gap-8 text-[13px] font-medium text-[#8b949e]">
      ...
      <div className="flex items-center gap-4">
        ...
        <a href="#" className="text-[13px] font-medium bg-[#1c2128] border border-white/10 text-white px-4 py-1.5 rounded-full hover:bg-[#2d333b] hover:border-white/20 transition-all shadow-sm">
          Sign Up
        </a>
      </div>
    </nav>
